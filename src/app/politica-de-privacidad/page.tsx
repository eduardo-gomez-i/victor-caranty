      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <section className="bg-white border border-gray-200 rounded-2xl shadow-sm p-8 md:p-10 space-y-6">
          ...
          <p className="text-gray-700 leading-relaxed">
            En Easy motores protegemos tus datos personales y los usamos únicamente para operar la plataforma, mejorar tu experiencia y cumplir obligaciones legales.
          </p>
          <p className="text-gray-700 leading-relaxed">
          ...
          <p className="text-gray-700 leading-relaxed">
            Si deseas actualizar o eliminar tus datos, puedes contactarnos en <span className="font-medium">contacto@easymotores.com</span>.
          </p>
        </section>
      </main>
      <Footer />
