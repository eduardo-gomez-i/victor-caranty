            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
              <div>
                ...
                <div className="flex gap-3">
                  <a
                    href="#"
                    className="h-10 w-10 rounded-full bg-white/5 flex items-center justify-center text-green-400 hover:bg-green-600 hover:text-white transition-all"
                  >
              ...
              <div>
                ...
                <ul className="space-y-4 text-sm text-white/80">
                  ...
                  <li>
                    <Link href="/publish#financiamiento" className="hover:text-green-400 transition-colors">
                      Financiamiento
                    </Link>
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="space-y-4 text-sm text-white/80">
                  <li>
                    <Link href="/publish" className="hover:text-green-400 transition-colors">
                      Vende tu auto
                    </Link>
                  </li>
                  <li>
